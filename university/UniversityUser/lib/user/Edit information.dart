                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          // تحقق من أن الرقم يبدأ بـ +963 أو 09
                          if (!value.startsWith('+963') &&
                              !value.startsWith('09')) {
                            return 'Phone number must start with +963 or 09';
                          }

                          // تحقق من الطول بناءً على بادئة الرقم
                          if (value.startsWith('+963') && value.length != 13) {
                            return 'Phone number must be exactly 12 digits when starting with +963';
                          } else if (value.startsWith('09') &&
                              value.length != 10) {
                            return 'Phone number must be exactly 10 digits when starting with 09';
                          }
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged: (value) {
                          context.read<UserCubit>().selectedPaymentMethod =
                              value;
                        },
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            context.read<UserCubit>().edituserprofail();
                            Navigator.push(
                              context,
                              MaterialPageRoute(
